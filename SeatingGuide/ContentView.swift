...
struct ContentView : View {
    ...
    var body: some View {
        ...
        return NavigationView {
            Form {
                Section(header: Text("Restaurant Area:".uppercased()), footer: Text("Drag the slider to change Seating or Total area of the Restaurant if Kitchen is included.").lineLimit(3)) {
                ...
                Section(header: Text("Number of Guests".uppercased()), footer: Text("general seating guidelines"))
                {
...
//                  Banquet, Minimum: 10 – 11 Square Feet
                ...
                .navigationBarTitle(Text("Seating"))
            }
